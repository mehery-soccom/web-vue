<script setup>
import { HorizontalNav } from "@app-notebook/@layouts/components";
import { useLayouts } from "@app-notebook/@layouts/composable/useLayouts";
...
<style lang="scss">
@use "@app-notebook/styles/variables/_template.scss" as variables;
@use "@app-notebook/@layouts/styles/placeholders";
@use "@app-notebook/@layouts/styles/mixins";
