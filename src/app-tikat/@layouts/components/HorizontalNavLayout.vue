<script setup>
import { HorizontalNav } from "@app-tikat/@layouts/components";
import { useLayouts } from "@app-tikat/@layouts/composable/useLayouts";
...
<style lang="scss">
@use "@app-tikat/styles/variables/_template.scss" as variables;
@use "@app-tikat/@layouts/styles/placeholders";
@use "@app-tikat/@layouts/styles/mixins";
