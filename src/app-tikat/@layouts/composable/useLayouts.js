import { AppContentLayoutNav, NavbarType } from "@app-tikat/@layouts/enums";
import { config } from "@app-tikat/@layouts/config";
import { injectionKeyIsVerticalNavHovered } from "@app-tikat/@layouts";
  ...
  const isVerticalNavCollapsed = computed({
    ...
    set(val) {
      ...
      localStorage.setItem(
        `${config.app.title}-isVerticalNavCollapsed`,
        val.toString()
      );
    },
  });
