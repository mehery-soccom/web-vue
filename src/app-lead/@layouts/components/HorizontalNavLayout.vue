<script setup>
import { HorizontalNav } from "@app-lead/@layouts/components";
import { useLayouts } from "@app-lead/@layouts/composable/useLayouts";
...
<style lang="scss">
@use "@app-lead/styles/variables/_template.scss" as variables;
@use "@app-lead/@layouts/styles/placeholders";
@use "@app-lead/@layouts/styles/mixins";
