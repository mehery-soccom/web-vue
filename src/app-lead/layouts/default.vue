<script setup>
import { useSkins } from "@app-lead/@core/composable/useSkins";
import { useThemeConfig } from "@app-lead/@core/composable/useThemeConfig";

// @layouts plugin
import { AppContentLayoutNav } from "@app-lead/@layouts/enums";
...
@use "@app-lead/@layouts/styles/default-layout";
</style>
