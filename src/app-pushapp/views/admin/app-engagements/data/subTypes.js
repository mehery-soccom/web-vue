    ...
    form: {
      fields: [
        ...
        },
        {
          ...
          path: "style.image_url",
          type: "file",
          label: "Image (Ideal aspect ratio : 4/3)",
          required: true,
        },
        {
          id: "road-img-btn",
    ...
    form: {
      fields: [
        ...
        },
        {
          ...
          type: "file",
          label: "Video (Ideal aspect ratio : 4/3)",
          required: true,
        },
        {
          id: "road-vid-btn",
    ...
    form: {
      fields: [
        ...
        },
        {
          ...
          path: "style.image_url",
          type: "file",
          label: "Image (Ideal aspect ratio : 3/4)",
          required: true,
        },
        {
          id: "road-img-btn",
    ...
    form: {
      fields: [
        ...
        },
        {
          ...
          path: "style.video_url",
          type: "file",
          label: "Video (Ideal aspect ratio : 3/4)",
          required: true,
        },
        {
          id: "road-vid-btn",
    ...
    preview: {
      dummy: {
          ...
          style: {
            ...
            line2_font_size: 12,
            line3_font_size: null,
            line1_font_color: "#060219",
            line2_font_color: "#1B094D",
            line3_font_color: "",
            line1_font_text_styles: [],
            line2_font_text_styles: [],
            line3_font_text_styles: [],
    ...
    form: {
      fields: [
        ...
        },
        {
          ...
          path: "style.image_url",
          type: "file",
          label: "Image (Maximum height and width allowed is 120px)",
          placeholder: "",
          required: true,
          readonly: false,
          defaultValue: null,
    ...
    form: {
      fields: [
        ...
        },
        {
          ...
          path: "style.video_url",
          type: "file",
          label: "Video (Maximum height and width allowed is 120px)",
          placeholder: "",
          required: true,
          readonly: false,
          defaultValue: null,
