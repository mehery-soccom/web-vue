<script setup>
import { HorizontalNav } from "@app-insights360/@layouts/components";
import { useLayouts } from "@app-insights360/@layouts/composable/useLayouts";
...
<style lang="scss">
@use "@app-insights360/styles/variables/_template.scss" as variables;
@use "@app-insights360/@layouts/styles/placeholders";
@use "@app-insights360/@layouts/styles/mixins";
